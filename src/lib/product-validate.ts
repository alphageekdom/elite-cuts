...
// Image upload validation for the admin product form. Cloudinary trusts what
// the server hands it, so this is the only gate between an admin upload and
// EliteCuts's image domain — we reject SVG (script-bearing), oversized
// blobs, and unexpected MIME types up front.
