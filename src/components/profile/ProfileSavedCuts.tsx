...
function BookmarkCard({
  ...
  return (
    <div className="bg-paper border border-line-soft rounded overflow-hidden transition-transform duration-400 hover:-translate-y-[3px]">
      <Link href={`/products/${bookmark._id}`} aria-label={bookmark.name} className="block">
        ...
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center gap-1.5">
            <button
              ...
              aria-label="Remove from saved cuts"
              className="w-8 h-8 rounded-full border border-line flex items-center justify-center text-muted transition-colors hover:border-oxblood hover:text-oxblood"
            >
            ...
            <button
              ...
              className="w-9 h-9 rounded-full bg-ink text-cream flex items-center justify-center transition-all hover:bg-oxblood hover:scale-[1.08] disabled:opacity-50"
            >
