...
export default function ProfileLoyaltyCard() {
  return (
    <div className="relative overflow-hidden bg-ink rounded p-7">
      ...
      <p className="relative text-[11px] tracking-[0.22em] uppercase text-camel mb-4">
        — Member tier
      </p>
      ...
      <div className="relative mb-3">
        <div className="h-[5px] rounded-full bg-cream/10 overflow-hidden">
          <div
            className="h-full rounded-full bg-gradient-to-r from-camel to-camel-soft"
