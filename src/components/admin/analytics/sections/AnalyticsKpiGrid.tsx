    ...
    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
      ...
      <div className="bg-paper border border-line-soft rounded-sm px-4 py-5 sm:px-6 sm:py-5.5 hover:border-line transition-colors">
        <div className="flex items-center justify-between mb-3.5">
          <span className="text-[10px] font-medium tracking-[0.14em] sm:tracking-[0.22em] uppercase text-muted">Avg Order</span>
      ...
      <div className="bg-paper border border-line-soft rounded-sm px-4 py-5 sm:px-6 sm:py-5.5 hover:border-line transition-colors">
        <div className="flex items-center justify-between mb-3.5">
          <span className="text-[10px] font-medium tracking-[0.14em] sm:tracking-[0.22em] uppercase text-muted">Repeat rate</span>
          <span className="w-5 h-5 sm:w-6.5 sm:h-6.5 rounded-full bg-cream-deep text-ink-soft grid place-items-center shrink-0">
            <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="bg-paper border border-line-soft rounded-sm px-4 py-5 sm:px-6 sm:py-5.5 hover:border-line transition-colors">
        <div className="flex items-center justify-between mb-3.5">
          <span className="text-[10px] font-medium tracking-[0.14em] sm:tracking-[0.22em] uppercase text-muted">New customers</span>
          <span className="w-5 h-5 sm:w-6.5 sm:h-6.5 rounded-full bg-cream-deep text-ink-soft grid place-items-center shrink-0">
            <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
      ...
      <div className="bg-paper border border-line-soft rounded-sm px-4 py-5 sm:px-6 sm:py-5.5 hover:border-line transition-colors">
        <div className="flex items-center justify-between mb-3.5">
          <span className="text-[10px] font-medium tracking-[0.14em] sm:tracking-[0.22em] uppercase text-muted">Cancel rate</span>
          <span className="w-5 h-5 sm:w-6.5 sm:h-6.5 rounded-full bg-cream-deep text-ink-soft grid place-items-center shrink-0">
            <svg className="w-3 h-3" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2">
