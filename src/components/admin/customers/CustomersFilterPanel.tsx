...
export default function CustomersFilterPanel({ filters, onChange, onClear, onClose }: Props) {
  ...
  return (
    <>
      ...
      <div className="absolute right-0 sm:right-auto sm:left-0 top-full mt-2 z-20 w-78 max-w-[calc(100vw-2rem)] bg-paper border border-line rounded-lg shadow-xl py-3">
